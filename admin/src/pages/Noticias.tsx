  ...
  return (
    <div style={{ padding: '32px' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '24px' }}>
        <h1 style={{ fontFamily: "'IBM Plex Serif', Georgia, serif", fontSize: '28px', fontWeight: 700, color: '#111110' }}>Noticias</h1>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              <tr style={{ background: '#f7f6f3' }}>
                {['Título', 'Sección', 'Estado', 'Vistas', 'Fecha', 'Acciones'].map((h) => (
                  <th key={h} style={{ padding: '10px 16px', fontFamily: "'IBM Plex Mono', monospace", fontSize: '10px', letterSpacing: '.1em', textTransform: 'uppercase', color: '#6b6b68', textAlign: 'left', borderBottom: '1px solid #e2e0da', whiteSpace: 'nowrap' }}>{h}</th>
                ))}
              </tr>
            </thead>
            <tbody>
              {filtradas.map((n) => (
                <tr key={n.id} style={{ borderBottom: '1px solid #f0ede8' }}>
                  ...
                  <td style={{ padding: '12px 16px', fontFamily: "'IBM Plex Mono', monospace", fontSize: '11px', color: '#9c9a94' }}>
                    {n.vistas}
                  </td>
                  <td style={{ padding: '12px 16px', fontFamily: "'IBM Plex Mono', monospace", fontSize: '10px', color: '#9c9a94', whiteSpace: 'nowrap' }}>
