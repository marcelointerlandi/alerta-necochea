  ...
  return (
    <div style={{ marginBottom: '24px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '14px' }}>
        ...
        <Link href={`/seccion/${slugSeccion}`} style={{
          fontFamily: "'IBM Plex Mono', monospace",
          fontSize: '13px', fontWeight: 600,
          color: '#6b6b68', textDecoration: 'none', whiteSpace: 'nowrap',
        }}>
          Ver todo →
        </Link>
      </div>
        ...
        {items.map((n) => (
          <div key={n.id} style={{ borderTop: `2px solid ${color}`, paddingTop: '10px' }}>
            {n.imagen_url ? (
              ...
              <div style={{
                width: '100%', aspectRatio: '16/9', background: '#edecea',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                fontFamily: "'IBM Plex Mono', monospace", fontSize: '9px',
                color: '#9c9a94', textTransform: 'uppercase', letterSpacing: '.1em',
                marginBottom: '10px',
              }}>
                Sin imagen
              </div>
